...
const Challengeaddone = (props) =>{
    ...
    const OnNextClick =()=>{
        props.navigation.navigate('CreateChallenge2');
    }
    ...
    return(
        ...
        <StatusBar
            ...
            <View style={{height:hp('8%'),width:wp('60%'),justifyContent:"center",alignItems:"center"}}>
                <Text style={{top:hp('0.5%'),color:myThemeColors.mainfontcolor,fontSize:myFontSize.h2.fontSize,fontFamily:myFontSize.h2.fontFamily,lineHeight:myFontSize.h2.lineHeight}}>Create a Challenge</Text>
            </View>
            <View style={{height:hp('8%'),width:wp('20%'),justifyContent:"center",alignItems:"center"}}>    
            <Text style={{fontSize:myFontSize.body.fontSize,fontFamily:myFontSize.body.fontFamily,lineHeight:myFontSize.body.lineHeight,color:myThemeColors.secondfontcolor}}>Step 1/5</Text>
            </View>
            </View>
            ...
            <View style={{height:hp('35%'),width:wp('100%'),alignItems:"center"}}>
                ...
                <View style={{height:hp('20%'),width:wp('90%'),}}>
                    <TextInput
                        ...
                        placeholder="eg. 20 000 steps per 2 days "
                        color="black"
                    />
                </View>
