...
import { Back_Icon, Check_Box_Icon_Unfilled,Check_Box_Icon_Filled, Clock_Icon, Flame_Color_Icon, Heart_Icon, Walk_Tile_Color_Icon, Bike_Tile_Color_Icon, Run_Tile_Color_Icon, Search_Icon,chevron_left,search} from '../utils/appconstants';
...
export default function inviteFriend(props){
    ...
    const OnNextClick =()=>{
        props.navigation.navigate('CreateChallenge6');
    }
                        ...
                        <ScrollView style={{ height: hp("83%") }} nestedScrollEnabled={true}>
                            ...
                            <View style={{ height: hp('9%'), width: wp("92%"), alignSelf: "center", flexDirection: "row", alignItems: "center" }}>
                                ...
                                <FlatList
                                    ...
                                    contentContainerStyle={{paddingBottom:hp('16%'),flexGrow:1}}
