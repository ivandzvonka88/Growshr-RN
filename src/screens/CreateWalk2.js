...
import {Back_Icon,Clock_Icon,Activities_Icon,Calendar_Icon,} from '../utils/appconstants';
...
const Challenge = (props) =>{
    ...
    const OnNextClick =()=>{
        props.navigation.navigate('CreateWalk3');
    }
    return(
        ...
        <StatusBar
            ...
            <View style={{height:hp('8%'),width:wp('60%'),justifyContent:"center",alignItems:"center"}}>
                <Text style={{top:hp('0.5%'),color:myThemeColors.mainfontcolor,fontSize:myFontSize.h2.fontSize,fontFamily:myFontSize.h2.fontFamily,lineHeight:myFontSize.h2.lineHeight}}>Walk Type</Text>
            </View>
            ...
            <View style={{height:hp('25%'),width:wp('100%'),flexDirection:"row"}}>
                ...
                >
                        ...
                        <View style={{alignItems:"center",height:hp('4%'),width:wp('4%'),justifyContent:"center"}}>
                            ...
                            source={Activities_Icon} resizeMode="contain"   
