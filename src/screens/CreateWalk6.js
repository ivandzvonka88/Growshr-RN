...
import { Back_Icon, Pensil_Icon, Walk_Tile_Color_Icon,calendar_tile_color_light,coin_tile_color_light,Steps_Tile_Color_Light3, Steps,mappin_tile_color_light, calendar, Clock, Coin, Trophy } from '../utils/appconstants'
        ...
        return ( 
            ...
            />
                ...
                <View style={{height:hp('8%'),marginTop:hp('2%'),width:wp('100%'),paddingLeft:wp('5%'),paddingRight:wp('2%'),alignSelf:"center",borderBottomWidth: hp('0.15%'), borderColor: myThemeColors.bordercolor_light,backgroundColor:myThemeColors.mainbg,flexDirection:"row",justifyContent:"space-between",alignItems:"center"}}>
                    <View style={{height:hp('8%'),width:wp('71%'),justifyContent:"center",alignItems:"flex-start"}}>
                        <View style={{ flexDirection: 'column',}}>
                            <Text style={{ color:myThemeColors.secondfontcolor,fontSize:myFontSize.small.fontSize,fontFamily:myFontSize.small.fontFamily,lineHeight:myFontSize.small.lineHeight }}>Walk Name</Text>
                            <Text style={{ color:myThemeColors.mainfontcolor,fontSize:myFontSize.h2.fontSize,fontFamily:myFontSize.h2.fontFamily,lineHeight:myFontSize.h2.lineHeight }}>Evening Walk</Text>
                        </View>                    
                    </View>
                ...
                <View style={{height:hp('8%'),width:wp('100%'),paddingLeft:wp('5%'),paddingRight:wp('2%'),alignSelf:"center",backgroundColor:myThemeColors.mainbg,flexDirection:"row",justifyContent:"space-between",alignItems:"center"}}>
                    <View style={{height:hp('8%'),width:wp('10%'),justifyContent:"center",alignItems:"center"}}>
                        <Image source={mappin_tile_color_light} style={{height:hp('6%'),width:hp('6%')}} resizeMode={"contain"} />
                    </View>
                    <View style={{height:hp('8%'),width:wp('71%'),justifyContent:"center",alignItems:"flex-start"}}>
                        <View style={{ flexDirection: 'column', padding: wp('5%'),}}>
                        <Text style={{ color:myThemeColors.secondfontcolor,fontSize:myFontSize.small.fontSize,fontFamily:myFontSize.small.fontFamily,lineHeight:myFontSize.small.lineHeight }}>Start Location</Text>
                            <Text style={{ color:myThemeColors.mainfontcolor,fontSize:myFontSize.h2.fontSize,fontFamily:myFontSize.h2.fontFamily,lineHeight:myFontSize.h2.lineHeight }} numberOfLines={1}>175 5th Ave, New York, NY 10010, United States</Text>
                        </View>                    
                    </View>
                <View style={{height:hp('8%'),width:wp('10%'),justifyContent:"center",alignItems:"flex-start"}}> 
                <TouchableOpacity>
                ...
                <View style={{height:hp('8%'),bottom:hp('1%'),width:wp('100%'),paddingLeft:wp('5%'),paddingRight:wp('2%'),alignSelf:"center",borderBottomWidth: hp('0.15%'), borderColor: myThemeColors.bordercolor_light,backgroundColor:myThemeColors.mainbg,flexDirection:"row",justifyContent:"space-between",alignItems:"center"}}>
                    ...
                    <View style={{height:hp('8%'),width:wp('71%'),justifyContent:"center",alignItems:"flex-start"}}>
                        <View style={{ flexDirection: 'column', padding: wp('5%'),}}>
                        <Text style={{ color:myThemeColors.secondfontcolor,fontSize:myFontSize.small.fontSize,fontFamily:myFontSize.small.fontFamily,lineHeight:myFontSize.small.lineHeight }}>End Location</Text>
                        <Text style={{ color:myThemeColors.mainfontcolor,fontSize:myFontSize.h2.fontSize,fontFamily:myFontSize.h2.fontFamily,lineHeight:myFontSize.h2.lineHeight }} numberOfLines={1}>West 96th Street & , Central Park West,New York</Text>
                        </View>                    
                    </View>
                <View style={{height:hp('8%'),width:wp('10%'),justifyContent:"center",alignItems:"flex-start"}}> 
                </View>
                ...
                <View style={{height:hp('8%'),bottom:hp('1%'),width:wp('100%'),paddingLeft:wp('5%'),paddingRight:wp('2%'),alignSelf:"center",borderBottomWidth: hp('0.15%'), borderColor: myThemeColors.bordercolor_light,backgroundColor:myThemeColors.mainbg,flexDirection:"row",justifyContent:"space-between",alignItems:"center"}}>
                    ...
                    <View style={{height:hp('8%'),width:wp('71%'),justifyContent:"center",alignItems:"flex-start"}}>
                        <View style={{ flexDirection: 'column', padding: wp('5%'),}}>
                        <Text style={{ color:myThemeColors.secondfontcolor,fontSize:myFontSize.small.fontSize,fontFamily:myFontSize.small.fontFamily,lineHeight:myFontSize.small.lineHeight }}>Date & Time</Text>
            ...
            <TouchableOpacity
                        ...
                        <Text style={{ fontSize: myFontSize.h3.fontSize, fontFamily: myFontSize.h3.fontFamily, lineHeight: myFontSize.h3.lineHeight, color: myThemeColors.white }}>Create a Walk</Text>
                    </TouchableOpacity>
            </View>
